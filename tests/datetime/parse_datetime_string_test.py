...
class TestParseDateTime:
    def test_lowercase_am_pm(self):
        ...
        expected_datetime = datetime(2019, 8, 4, hour=14, minute=30, tzinfo=tz.gettz('America/Los_Angeles'))
    ...
    def test_uppercase_am_pm(self):
        ...
        expected_datetime = datetime(2019, 8, 4, hour=2, minute=30, tzinfo=tz.gettz('America/Los_Angeles'))
        assert expected_datetime == parse_datetime_string(datetime_string)
    ...
    def test_without_minutes(self):
        ...
        expected_datetime = datetime(2019, 8, 4, hour=14, tzinfo=tz.gettz('America/Los_Angeles'))
        assert expected_datetime == parse_datetime_string(datetime_string)
